...
namespace Jointure
{
    public class SettingsMenu : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            ApplyLayerToHierarchy(gameObject, LayerMask.NameToLayer("JointureMenu"));
            _visualFloorOffset.layer = LayerMask.NameToLayer("JointureMenu");
